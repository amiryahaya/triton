...
func TestRegisterDefaultModules(t *testing.T) {
	...
	// Should register all 51 modules:
	...
	// Wave 4 — FIDO2/WebAuthn + blockchain wallet + Helm chart scanners.
