...
func tlsGroupData() []TLSGroup {
	return []TLSGroup{
		...
		{ID: 0x0017, Name: "secp256r1", KeySize: 256, Status: TRANSITIONAL},
		{ID: 0x0018, Name: "secp384r1", KeySize: 384, Status: SAFE},
		{ID: 0x0019, Name: "secp521r1", KeySize: 521, Status: SAFE},
		{ID: 0x001D, Name: "x25519", KeySize: 256, Status: TRANSITIONAL},
		{ID: 0x001E, Name: "x448", KeySize: 448, Status: SAFE},

		// --- Classical finite-field DHE ---
		{ID: 0x0100, Name: "ffdhe2048", KeySize: 2048, Status: TRANSITIONAL},
		{ID: 0x0101, Name: "ffdhe3072", KeySize: 3072, Status: SAFE},
		{ID: 0x0102, Name: "ffdhe4096", KeySize: 4096, Status: SAFE},
		{ID: 0x0103, Name: "ffdhe6144", KeySize: 6144, Status: SAFE},
		{ID: 0x0104, Name: "ffdhe8192", KeySize: 8192, Status: SAFE},

		// --- Brainpool curves ---
		{ID: 0x001A, Name: "brainpoolP256r1", KeySize: 256, Status: TRANSITIONAL},
		{ID: 0x001B, Name: "brainpoolP384r1", KeySize: 384, Status: TRANSITIONAL},
		{ID: 0x001C, Name: "brainpoolP512r1", KeySize: 512, Status: SAFE},

		// --- Deprecated/legacy ---
		{ID: 0x0015, Name: "secp192r1", KeySize: 192, Status: UNSAFE},
		{ID: 0x0016, Name: "secp224r1", KeySize: 224, Status: DEPRECATED},

		// --- Pure PQC KEMs (standalone, not hybrid) ---
		{ID: 0x0200, Name: "MLKEM512", KeySize: 512, Status: SAFE,
			ComponentAlgorithms: []string{"ML-KEM-512"}},
		{ID: 0x0201, Name: "MLKEM768", KeySize: 768, Status: SAFE,
			ComponentAlgorithms: []string{"ML-KEM-768"}},
		{ID: 0x0202, Name: "MLKEM1024", KeySize: 1024, Status: SAFE,
			ComponentAlgorithms: []string{"ML-KEM-1024"}},

		// --- NIST-ratified hybrid ML-KEM groups (draft-kwiatkowski-tls-ecdhe-mlkem) ---
		{ID: 0x11EB, Name: "SecP256r1MLKEM768", KeySize: 256, IsHybrid: true,
			ComponentAlgorithms: []string{"secp256r1", "ML-KEM-768"}, Status: SAFE},
		{ID: 0x11EC, Name: "X25519MLKEM768", KeySize: 256, IsHybrid: true,
			ComponentAlgorithms: []string{"X25519", "ML-KEM-768"}, Status: SAFE},
		{ID: 0x11ED, Name: "SecP384r1MLKEM1024", KeySize: 384, IsHybrid: true,
			ComponentAlgorithms: []string{"secp384r1", "ML-KEM-1024"}, Status: SAFE},

		// --- Draft Kyber hybrids (pre-standard, deployed 2023-2025) ---
		{ID: 0x6399, Name: "X25519Kyber768Draft00", KeySize: 256, IsHybrid: true,
			ComponentAlgorithms: []string{"X25519", "Kyber-768"}, Status: SAFE},
		{ID: 0x639A, Name: "SecP256r1Kyber768Draft00", KeySize: 256, IsHybrid: true,
			ComponentAlgorithms: []string{"secp256r1", "Kyber-768"}, Status: SAFE},
		{ID: 0xFE30, Name: "X25519Kyber512Draft00", KeySize: 256, IsHybrid: true,
			ComponentAlgorithms: []string{"X25519", "Kyber-512"}, Status: SAFE},
		{ID: 0xFE31, Name: "X25519Kyber768Draft00Old", KeySize: 256, IsHybrid: true,
			ComponentAlgorithms: []string{"X25519", "Kyber-768"}, Status: SAFE},
		...
		{ID: 0x023A, Name: "frodo640aes", KeySize: 640, Status: SAFE,
			ComponentAlgorithms: []string{"FrodoKEM-640-AES"}},
		{ID: 0x023C, Name: "frodo976aes", KeySize: 976, Status: SAFE,
