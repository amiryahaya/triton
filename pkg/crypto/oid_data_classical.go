...
func classicalOIDs() map[string]OIDEntry {
	return map[string]OIDEntry{
		...
		"2.16.840.1.101.3.4.2.7":  {OID: "2.16.840.1.101.3.4.2.7", Algorithm: "SHA3-224", Family: "SHA3", Status: TRANSITIONAL},
		...
		"1.3.132.0.34":        {OID: "1.3.132.0.34", Algorithm: "ECDSA-P384", Family: "ECDSA", KeySize: 384, Status: TRANSITIONAL},
		"1.3.132.0.35":        {OID: "1.3.132.0.35", Algorithm: "ECDSA-P521", Family: "ECDSA", KeySize: 521, Status: TRANSITIONAL},
